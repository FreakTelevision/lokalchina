      ...
      <section className="max-w-3xl mx-auto px-6 pb-32">
        <div className="bg-gray-50 border border-gray-200 p-8 md:p-12">
          ...
          <form className="space-y-8">
            ...
            <div className="pt-4"><button type="submit" className="w-full bg-black text-white text-[11px] font-semibold tracking-[0.25em] uppercase py-4 hover:bg-gray-800 transition-all duration-300">Submit My Bespoke Blueprint</button></div>
          </form>
        </div>
      </section>
    </div>
