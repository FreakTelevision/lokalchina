        ...
        <div className="bg-[#121318] border border-white/10 p-8 md:p-12 shadow-2xl">
          ...
          <form className="space-y-8">
            <div className="space-y-2">
              ...
              <input type="text" placeholder="e.g. Shanxi, Jingdezhen, Yiwu, or a multi-city route..." className="w-full bg-black/40 border border-white/10 focus:border-white px-4 py-3.5 text-xs tracking-wider outline-none text-white font-light" required />
            </div>
            <div className="space-y-2">
