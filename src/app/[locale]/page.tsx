...
export default async function HomePage({ params }: PageProps) {
  ...
  const featuredRoutes = [
    ...
    { slug: "jingdezhen-ceramics", days: "4 NIGHTS", subtitle: "JIANGXI, CHINA", title: "HANDS-ON CERAMICS & KILN HERITAGE", image: "https://images.pexels.com/photos/15402564/pexels-photo-15402564.jpeg?auto=format&fit=crop&q=80&w=800" },
    { slug: "yiwu-yongkang-sourcing", days: "5 NIGHTS", subtitle: "ZHEJIANG, CHINA", title: "THE SUPPLY CHAIN EXPEDITION", image: "https://images.pexels.com/photos/30371604/pexels-photo-30371604.jpeg?auto=format&fit=crop&q=80&w=800" }
  ];
